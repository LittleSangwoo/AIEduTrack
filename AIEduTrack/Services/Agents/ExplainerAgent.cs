...
Правила:
ОТВЕЧАЙ СТРОГО НА РУССКОМ ЯЗЫКЕ (REPLY IN RUSSIAN LANGUAGE ONLY).
1. Свяжи курс с должностью и ведомством (ИОГВ) ггс.
2. Упомяни навыки, которые он разовьет.
3. Время от времени (не всегда) добавляй фразу вроде 'Коллеги вашей должности часто выбирают этот курс' или 'Этот курс популярен в вашем ИОГВ', чтобы показать опору на данные других пользователей.
4. Пиши профессионально и дружелюбно. Выведи ТОЛЬКО текст обоснования. Никаких кавычек, списков или вступительных фраз.";
